...
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerAvailable(int *nbrCtrl);
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerSerialNumber(int noContr, char* serialNumber);
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerPort(int noCtrl, int* unit, int* channel);
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerCommInterface(int noCtrl, enum CommType *commInterface);
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerMacAddress(int noCtrl, char* macAddress);
/*Deprecated*/ NC_FUNCTION int ncGrabGetControllerPresent(int unit, int channel, int* state);
...
NC_FUNCTION int ncGrabGetImageParams(NcGrab grab, void* imageNc, ImageParams imageParams);
...
NC_FUNCTION int ncGrabSaveImage(NcGrab grab, const NcImage* imageNc, const char* saveName, enum ImageFormat saveFormat, int overwriteFlag);
...
NC_FUNCTION int ncGrabStartSaveAcquisition(NcGrab grab, const char *saveName, enum ImageFormat saveFormat, int imagesPerCubes, int nbrOfCubes, int overwriteFlag);
...
NC_FUNCTION int ncGrabGetCtrlTimestamp(NcGrab grab, NcImage* imageAcqu, struct tm *ctrTimestamp, double *ctrlSecondFraction, int *status);
...
// Communication settings of the camera if not a nc one
...
// Communication function with cam if other than the nc one
...
NC_FUNCTION int ncGrabStatsGetCrossSection(NcGrab grab, int regionIndex, const NcImage *image, int xCoord, int yCoord, double statsCtxRegion[5], double **histo, double **crossSectionHorizontal, double **crossSectionVertical);
NC_FUNCTION int ncGrabStatsGetGaussFit(NcGrab grab, int regionIndex, const NcImage *image, int xCoord, int yCoord, double *maxAmplitude, double gaussSumHorizontal[3], double gaussSumVertical[3], int useActualCrossSection);

/*Deprecated*/ NC_FUNCTION int ncCamGetCameraPresent(int unit, int channel, int* state);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraAvailable(int *nbrCamera);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraPort(int noCamera, int* unit, int* channel);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraCommInterface(int noCamera, enum CommType *commInterface);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraMacAddress(int noCamera, char *macAddress);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraSerialNumber(int noCamera, char* serialNumber);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraDetectorSize(int noCamera, int* detectorSizeX, int* detectorSizeY);
/*Deprecated*/ NC_FUNCTION int ncCamGetCameraDetectorType(int noCamera, enum DetectorType *detectorType);
...
NC_FUNCTION int ncCamReadyToClose(NcCam cam, void (*fct)(NcCam cam, void *data), void *data);
...
NC_FUNCTION int ncSaveImage(int width, int height, ImageParams imageParams, const void* imageNc, enum ImageDataType dataType, const char* saveName, enum ImageFormat saveFormat, enum ImageCompression compress, const char* addComments, int overwriteFlag);
NC_FUNCTION int ncCamOpenImageParams(ImageParams *imageParams);
NC_FUNCTION int ncCamGetImageParams(NcCam cam, void* imageNc, ImageParams imageParams);
...
NC_FUNCTION int ncCamSaveImage(NcCam cam, const NcImage* imageNc, const char* saveName, enum ImageFormat saveFormat, const char* addComments, int overwriteFlag);
...
NC_FUNCTION int ncCamStartSaveAcquisition(NcCam cam, const char *saveName, enum ImageFormat saveFormat, int imagesPerCubes, const char *addComments, int nbrOfCubes, int overwriteFlag);
...
// ncCam parameters specific functions
...
NC_FUNCTION int ncCamStatsGetCrossSection(NcCam cam, int regionIndex, const NcImage *image, int xCoord, int yCoord, double statsCtxRegion[5], double **histo, double **crossSectionHorizontal, double **crossSectionVertical);
NC_FUNCTION int ncCamStatsGetGaussFit(NcCam cam, int regionIndex, const NcImage *image, int xCoord, int yCoord, double *maxAmplitude, double gaussSumHorizontal[3], double gaussSumVertical[3], int useActualCrossSection);
...
NC_FUNCTION int ncProcProcessDataImageInPlace(NcProc ctx, NcImage *image);
NC_FUNCTION int ncProcProcessDataImageInPlaceForceType(NcProc ctx, NcImage *image, int procType);
...
NC_FUNCTION int ncStatsGetHistoCrossSection (NcStatsCtx *statsCtx, int regionIndex, const NcImage *image, int xCoord, int yCoord, double statsCtxRegion[5], double **histo, double **crossSectionHorizontal, double **crossSectionVertical);
NC_FUNCTION int ncStatsGetGaussFit(NcStatsCtx *statsCtx, int regionIndex, const NcImage *image, int xCoord, int yCoord, double *maxAmplitude, double gaussSumHorizontal[3], double gaussSumVertical[3], int useActualCrossSectionFlag);
...
// Framegrabber settings functions (grab version)
...
// Framegrabber settings functions (cam version)
