...
#define NC_ERROR_CAM_PARSE_INIT             76		//One of the passed parameter hasn't been properly initialized
...
#define NC_ERROR_CAM_NO_READOUT             108		//The readout mode loaded isn't a valid one
...
#define NC_ERROR_CAM_PARAM_OPEN             115		//The camera parameter file speified can't be opened
...
#define NC_ERROR_CAM_READOUT_MODE_INVALID	133		//The selected readout mode does not conform to the requirements of a CamContext
...
#define NC_ERROR_GRAB_REG_MISS              205		//Some of the mandatory nc registry keys haven't been setup properly.  Please contact nc Technical support to remedy this issue.
...
#define NC_ERROR_GRAB_TIMESTAMP_SKIP        227
#define NC_ERROR_GRAB_GPS_UNLOCK            228
#define NC_ERROR_GRAB_NO_TIMESTAMP          229
...
#define NC_ERROR_GRAB_GPS_INVALID           234 	// Timestamp information received from the GPS unit is not valid: it must provide the NEMA GPZDA sentence
