...
int nbrBuffer=64;//This parameter represents the number of buffers that will receive acquired images from the camera. These buffers will receive images one after the other such that one or more buffers can be used/processed while another one receives a new image from the camera
std::string adress_tcs;
NcCam myCam;
NcImage	*myNcImage;


Log log("/home/jonathan/");
FW fw;
